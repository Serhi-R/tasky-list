    ...
    <div className="login-form">
      <div className="login-form__container">
        <div className="login-form__logo">
          ...
          <h2 className="login-form__brand">Tasky</h2>
        </div>

        <div className="login-form__header">
          <h1 className="login-form__title">Login</h1>
          <p className="login-form__subtitle">Welcome back! Please login to your account.</p>
        </div>

        {error && (
          <Alert severity="error" className="login-form__error">
            {error}
          </Alert>
        )}
